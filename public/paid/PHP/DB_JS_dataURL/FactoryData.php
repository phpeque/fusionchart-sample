<?php
    ...
    $strQuery = "select Quantity, DATE_FORMAT(DatePro,'%d/%m') as DatePro from Factory_Output where FactoryId=" . $FactoryId;
    ...
    if ($result) {
        while($ors = mysql_fetch_array($result)) {
            ...
            $strXML .= "<set label='" . $ors['DatePro'] . "' value='" . $ors['Quantity'] . "'/>";
        }
    }
    mysql_close($link);
